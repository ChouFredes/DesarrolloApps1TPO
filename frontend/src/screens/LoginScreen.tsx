...
export function LoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      const { accessToken, refreshToken, usuarioId, nombre, apellido, categoria, admitido, nivel } = res.data;
      login(accessToken, refreshToken, { id: usuarioId, nombre, apellido, categoria, admitido, nivel });
    } catch (e: any) {
